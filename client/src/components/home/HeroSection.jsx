  ...
  return (
    <section className="w-full relative bg-white">
      ...
      <div className="w-full relative" style={{ zIndex: 1 }}>
        <div className="w-full px-2 sm:px-6 py-2 sm:py-6">
          <div className="flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-3">
            {/* SUVIDHA Logo */}
            <div className="flex items-center gap-2 sm:gap-3 hidden sm:flex">
              <div className="w-14 sm:w-32 h-14 sm:h-32">
            ...
            <div className="text-center flex-1 px-1 sm:px-4">
              <div className="text-[10px] sm:text-sm text-gray-900 mb-0 font-bold tracking-tight sm:tracking-wide">{t('hero.govOfIndia')}</div>
              <h1 className="text-sm sm:text-3xl md:text-6xl font-black leading-tight">
                <span
                  style={{
              ...
              <div className="text-[10px] sm:text-sm text-gray-900 mt-0 sm:mt-0.5 font-bold tracking-tight sm:tracking-wide">{t('hero.govInitiative')}</div>
            </div>

            {/* SUVIDHA Emblem */}
            <div className="w-14 sm:w-32 h-14 sm:h-32 hidden sm:block">
