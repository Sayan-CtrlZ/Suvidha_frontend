              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-full p-8 pb-12 flex flex-col justify-between z-10">
                    ...
                    <div className="w-fit self-center mt-6 py-3 px-16 bg-gradient-to-r from-emerald-500 to-green-600 border border-emerald-500 border-b-4 border-b-emerald-800 rounded-xl flex items-center justify-center gap-2 text-sm font-bold uppercase tracking-wider text-white shadow-lg shadow-emerald-200 group-hover:shadow-emerald-400 transition-all group-active:border-b-0 group-active:translate-y-1">
