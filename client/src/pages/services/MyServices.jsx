            ...
            <main className="grow relative z-10 py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="text-center mb-12 relative">
                        <BackButton to="/dashboard" className="absolute left-0 top-1/2 -translate-y-1/2 scale-75 origin-left" />
                        <h1 className="text-4xl font-extrabold text-gray-900 mb-4 tracking-tight flex items-center justify-center gap-3">
                            <Layers className="text-purple-600" size={36} />
                            {t('nav.myServices')}
                        </h1>
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto font-medium">
                            Manage all your subscribed government services and track ongoing applications in one place.
                        </p>
                    </div>
                                ...
                                {activeServices.map((service) => {
                                    ...
                                    return (
                                        <div key={service.id} className="bg-white rounded-3xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-all group">
                                            ...
                                            <button className="w-full py-3 bg-gray-900 text-white rounded-xl font-bold text-sm hover:bg-gray-800 transition-colors flex items-center justify-center gap-2">
                                                View Details
                                                <ArrowRight size={16} />
                                            </button>
                                        </div>
