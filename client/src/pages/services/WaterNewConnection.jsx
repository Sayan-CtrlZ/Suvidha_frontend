...
import {
  User, MapPin, Droplet, FileCheck, CheckCircle2, ChevronRight, ChevronLeft,
...
const WaterNewConnectionPage = () => {
  ...
  const steps = [
    ...
    { id: 3, name: t('newConnection.steps.connection'), icon: Droplet },
  ...
  const generateApplicationNo = () => {
    return `WATER-${new Date().getFullYear()}-${Math.random().toString(36).substr(2, 9).toUpperCase()}`;
  };
            ...
            <div className="p-4 sm:p-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('newConnection.applicantDetails.fullName')} <span className="text-blue-500">*</span>
                      </label>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:outline-none transition-colors ${errors.fullName ? 'border-blue-300 focus:border-blue-400' : 'border-gray-200 focus:border-violet-400'
                            }`}
                        />
                      </div>
                      {errors.fullName && <p className="text-xs text-blue-500 mt-1">{errors.fullName}</p>}
                    </div>

                    {/* Mobile Number */}
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('newConnection.applicantDetails.mobile')} <span className="text-blue-500">*</span>
                      </label>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:outline-none transition-colors ${errors.mobile ? 'border-blue-300 focus:border-blue-400' : 'border-gray-200 focus:border-violet-400'
                            }`}
                        />
                      </div>
                      {errors.mobile && <p className="text-xs text-blue-500 mt-1">{errors.mobile}</p>}
                    </div>

                    {/* Email */}
                    <div className="sm:col-span-2">
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('newConnection.applicantDetails.email')} <span className="text-blue-500">*</span>
                      </label>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:outline-none transition-colors ${errors.email ? 'border-blue-300 focus:border-blue-400' : 'border-gray-200 focus:border-violet-400'
                            }`}
                        />
                      </div>
                      {errors.email && <p className="text-xs text-blue-500 mt-1">{errors.email}</p>}
                    </div>

                    {/* ID Proof Type */}
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('newConnection.applicantDetails.idProof')} <span className="text-blue-500">*</span>
                      </label>
                      <div className="relative">
                        ...
                        <select
                          ...
                          className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:outline-none transition-colors appearance-none bg-white ${errors.idProofType ? 'border-blue-300 focus:border-blue-400' : 'border-gray-200 focus:border-violet-400'
                            }`}
                        >
                      ...
                      {errors.idProofType && <p className="text-xs text-blue-500 mt-1">{errors.idProofType}</p>}
                    </div>

                    {/* Document Number */}
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('newConnection.applicantDetails.documentNumber')} <span className="text-blue-500">*</span>
                      </label>
                      <input
                        type="text"
                        ...
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition-colors ${errors.documentNumber ? 'border-blue-300 focus:border-blue-400' : 'border-gray-200 focus:border-violet-400'
                          }`}
                      />
                      {errors.documentNumber && <p className="text-xs text-blue-500 mt-1">{errors.documentNumber}</p>}
                    </div>
                  </div>
                  ...
                  <div className="mt-8 p-5 bg-gray-50 rounded-2xl border-2 border-gray-200">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div>
                        <p className="text-xs font-medium text-gray-600 mb-2">
                          {t('newConnection.applicantDetails.uploadFront')} <span className="text-blue-500">*</span>
                        </p>
                        <input
                          type="file"
                          ref={fileInputRef}
                        ...
                        {formData.documentFrontPreview ? (
                          ...
                          <button
                            onClick={() => fileInputRef.current?.click()}
                            className={`w-full h-40 border-2 border-dashed rounded-xl flex flex-col items-center justify-center gap-2 hover:border-violet-400 hover:bg-violet-50 transition-colors ${errors.documentFront ? 'border-blue-300 bg-blue-50' : 'border-gray-300'
                              }`}
                          >
                        ...
                        {errors.documentFront && <p className="text-xs text-blue-500 mt-1">{errors.documentFront}</p>}
                      </div>
                    ...
                    {formData.documentFront && formData.documentNumber && (
                      <div className="mt-5">
                        ...
                        {errors.verification && <p className="text-xs text-blue-500 mt-1">{errors.verification}</p>}
                      </div>
                    )}
                  </div>
                </div>
              ...
              {currentStep === 2 && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('newConnection.addressDetails.houseNo')} <span className="text-blue-500">*</span>
                      </label>
                      <input
                        type="text"
                        ...
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition-colors ${errors.houseNo ? 'border-blue-300 focus:border-blue-400' : 'border-gray-200 focus:border-violet-400'
                          }`}
                      />
                      {errors.houseNo && <p className="text-xs text-blue-500 mt-1">{errors.houseNo}</p>}
                    </div>

                    {/* Street/Locality */}
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('newConnection.addressDetails.streetLocality')} <span className="text-blue-500">*</span>
                      </label>
                      <input
                        type="text"
                        ...
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition-colors ${errors.street ? 'border-blue-300 focus:border-blue-400' : 'border-gray-200 focus:border-violet-400'
                          }`}
                      />
                      {errors.street && <p className="text-xs text-blue-500 mt-1">{errors.street}</p>}
                    </div>
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('newConnection.addressDetails.state')} <span className="text-blue-500">*</span>
                      </label>
                      <select
                        value={formData.state}
                        onChange={(e) => handleChange('state', e.target.value)}
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition-colors appearance-none bg-white ${errors.state ? 'border-blue-300 focus:border-blue-400' : 'border-gray-200 focus:border-violet-400'
                          }`}
                      >
                      ...
                      {errors.state && <p className="text-xs text-blue-500 mt-1">{errors.state}</p>}
                    </div>

                    {/* District */}
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('newConnection.addressDetails.district')} <span className="text-blue-500">*</span>
                      </label>
                      <input
                        type="text"
                        ...
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition-colors ${errors.district ? 'border-blue-300 focus:border-blue-400' : 'border-gray-200 focus:border-violet-400'
                          }`}
                      />
                      {errors.district && <p className="text-xs text-blue-500 mt-1">{errors.district}</p>}
                    </div>
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('newConnection.addressDetails.city')} <span className="text-blue-500">*</span>
                      </label>
                      <input
                        type="text"
                        value={formData.city}
                        ...
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition-colors ${errors.city ? 'border-blue-300 focus:border-blue-400' : 'border-gray-200 focus:border-violet-400'
                          }`}
                      />
                      {errors.city && <p className="text-xs text-blue-500 mt-1">{errors.city}</p>}
                    </div>

                    {/* PIN Code */}
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('newConnection.addressDetails.pincode')} <span className="text-blue-500">*</span>
                      </label>
                      <input
                        type="text"
                        ...
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition-colors ${errors.pincode ? 'border-blue-300 focus:border-blue-400' : 'border-gray-200 focus:border-violet-400'
                          }`}
                      />
                      {errors.pincode && <p className="text-xs text-blue-500 mt-1">{errors.pincode}</p>}
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-4">
                      {t('newConnection.connectionDetails.connectionType')} <span className="text-blue-500">*</span>
                    </label>
                    ...
                    {errors.connectionType && <p className="text-xs text-blue-500 mt-1">{errors.connectionType}</p>}
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('newConnection.connectionDetails.loadRequired')} <span className="text-blue-500">*</span>
                      </label>
                      <select
                        value={formData.loadRequired}
                        onChange={(e) => handleChange('loadRequired', e.target.value)}
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition-colors appearance-none bg-white ${errors.loadRequired ? 'border-blue-300 focus:border-blue-400' : 'border-gray-200 focus:border-violet-400'
                          }`}
                      >
                      ...
                      {errors.loadRequired && <p className="text-xs text-blue-500 mt-1">{errors.loadRequired}</p>}
                    </div>
              ...
              {currentStep === 4 && (
                <div className="space-y-6">
                  ...
                  {errors.termsAccepted && <p className="text-xs text-blue-500">{errors.termsAccepted}</p>}
                </div>
              )}
...
export default WaterNewConnectionPage;
