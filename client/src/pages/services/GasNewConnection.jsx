...
import {
  User, MapPin, Flame, FileCheck, CheckCircle2, ChevronRight, ChevronLeft,
...
const GasNewConnectionPage = () => {
  ...
  const steps = [
    ...
    { id: 3, name: t('newConnection.steps.connection'), icon: Flame },
  ...
  const generateApplicationNo = () => {
    return `GAS-${new Date().getFullYear()}-${Math.random().toString(36).substr(2, 9).toUpperCase()}`;
  };
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="w-full pt-2 md:pt-3 pb-4 md:pb-5 px-3 sm:px-6 bg-gradient-to-br from-orange-900 via-red-800 to-orange-900 shadow-2xl relative overflow-hidden">
        {/* Sophisticated Mesh Background Pattern */}
        <div className="absolute inset-0 opacity-[0.25]">
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="grid-gas-newconn" width="40" height="40" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#grid-gas-newconn)" />
          </svg>
        </div>

        {/* Elegant Gradient Orbs */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-orange-400/30 to-red-500/30 rounded-full blur-3xl transform translate-x-1/3 -translate-y-1/3" />
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-red-400/25 to-orange-500/25 rounded-full blur-3xl transform -translate-x-1/3 translate-y-1/3" />

        {/* Decorative Line Accent */}
        <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-orange-400/30 to-transparent" />
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-white tracking-wide">Apply for Gas Connection</h1>
              <p className="text-orange-50 text-sm sm:text-base mt-1 font-medium">Complete the form to get a new gas connection</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <main className="flex-1 px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        <div className="max-w-5xl mx-auto">
          {/* Top Back Button */}
          <div className="mb-6">
            <BackButton to="/services/gas" text={t('common.back')} />
          </div>
...
export default GasNewConnectionPage;
