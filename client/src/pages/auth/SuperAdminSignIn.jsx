...
import { Lock, User, ArrowLeft, CheckCircle2, AlertCircle } from 'lucide-react';
...
const SuperAdminSignIn = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (result.success) {
            ...
            setError(result.error || 'Authentication credentials invalid.');
        }
    };
        ...
        <div className="min-h-screen bg-slate-100 flex flex-col font-sans text-slate-900">
            ...
            <div className="bg-white text-slate-900 shadow-md z-20 border-b border-slate-200 py-2">
                <div className="max-w-7xl mx-auto flex justify-between items-center relative px-6">
                    ...
                    {/* Left: Logo - Matching Hero Section Scale */}
            ...
            <div className="flex-1 flex items-center justify-center p-4 relative overflow-hidden">
                ...
                {/* Decor: Ashoka Chakra / Official Circle hint (CSS only) */}
                <div className="absolute -left-20 top-1/2 -translate-y-1/2 w-96 h-96 rounded-full border-[20px] border-slate-200/50 -z-10" />


                {/* Login Card */}
                <div className="relative z-10 w-full max-w-sm bg-white rounded-sm shadow-[0_20px_50px_rgba(15,23,42,0.15)] border-t-4 border-slate-900 overflow-hidden">
                    ...
                    <div className="p-6 md:p-8">
                        ...
                        <div className="text-center mb-6">
                            <div className="inline-flex items-center justify-center mb-4">
                                <img src={emblem} alt="National Emblem" className="h-16 w-auto drop-shadow-sm" />
                            </div>
                            <h1 className="text-xl font-bold text-slate-900 uppercase tracking-tight mb-2">Central Administration</h1>
                            <div className="h-1 w-16 bg-gradient-to-r from-amber-500 to-yellow-500 mx-auto rounded-full mb-3" />
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="block w-full pl-10 pr-3 py-2 border border-slate-300 rounded-md text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-slate-800 focus:ring-1 focus:ring-slate-800 transition-all shadow-sm"
                            ...
                            <div className="pt-2">
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="w-full flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-white font-bold py-3.5 px-4 rounded-md shadow-lg shadow-slate-900/10 transition-all duration-200 disabled:opacity-70"
                                >
                                    {isLoading ? (
